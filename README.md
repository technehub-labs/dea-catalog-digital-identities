...
> A digital representation of a Customer, Partner, or Bot that participates in the ecosystem.

**Layer:** L3 · **Entity:** `DI` · **Metamodel:** [v2.0.0-alpha](https://github.com/technehub-labs/dea-metamodel)

[![View in Metamodel Explorer](https://img.shields.io/badge/Metamodel%20Explorer-View%20Entity-2C3E50?style=shield)](https://technehub-labs.github.io/metamodel/?entity=DI)
...
```
dea-catalog-digital-identities/
